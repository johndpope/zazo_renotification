class Message::Send
  ...
  def do
    unless check_program_exist
      Zazo::Tool::Logger.info(self, "program was already soft-deleted; message: #{message.to_json}")
      set_status(:canceled)
      return
    end
    ...
    Zazo::Tool::Logger.info(self, "was trying to send message; message: #{message.to_json}")
  end
